...
public class TicketListAdapter extends RecyclerView.Adapter<TicketListAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public TicketImageView ticketImage;

        public ViewHolder(View v) {
            super(v);
            txtHeader = (TextView) v.findViewById(R.id.firstLine);
            txtFooter = (TextView) v.findViewById(R.id.secondLine);
            ticketImage = (TicketImageView) v.findViewById(R.id.icon);
        }
    }

    // Provide a suitable constructor (depends on the kind of dataset)
    public TicketListAdapter(String[] myDataset) {
        mDataset = myDataset;
    }
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.ticketImage.setUsed(new Random().nextBoolean());
