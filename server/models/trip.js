        ...
        db.query('START startNode=Node({departureStationId}), endNode=Node({arrivalStationId}) ' +
            ...
            (err, results) => {
                ...
                db.query('MATCH path = (departureStation:station)-[trips:trip]->(arrivalStation:station) ' +
                    ...
                    '| {id: ID(r), departureDate: r.departureDate, arrivalDate: r.arrivalDate, trainId: r.trainId, prevStationName: STARTNODE(r).name, nextStationName: ENDNODE(r).name, distance: r.distance}) ' +
                    ...
                    (err, results) => {
                        ...
                        var reducer = (lastElem, currentStation, callback) => {
                            db.query('MATCH path = (departureStation:station)-[trips:trip]->(arrivalStation:station) ' +
                                ...
                                'arrivalDate: r.arrivalDate, trainId: r.trainId, prevStationName: STARTNODE(r).name, nextStationName: ENDNODE(r).name, distance: r.distance}) ' +
